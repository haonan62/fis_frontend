...
const MultipleLineProduction = (props) => {
    ...
    if (predictionData) {
        ...
        console.log("sample",extractedData);
    }
    ...
    useEffect(() => {
        if (extractedData && timeRange && valueRange) {
            ...
            // svg
            //     .select(".x-axis").attr("class", "y-axis")
            ...
            var path = svg.selectAll(".line")
                ...
                // the following line is to make dashed line
...
export default MultipleLineProduction;