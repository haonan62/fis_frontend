...
const LineChartWithVerticalEdit = (props) => {
    ...
    useEffect(() => {
        ...
        const xAxis = axisBottom(xScale).ticks(sortedExtractedData.length).tickFormat(timeFormat("%Y/%m/%d"));
    ...
    }, [sortedExtractedData,whatIfData]);
...
export default LineChartWithVerticalEdit;
